  ...
  return `
    <div class="about-screen">
      ...
      <div class="team-grid" style="margin-top:0.9rem">
        <div class="team-card">
          <p class="tc-uni">University 1</p>
          <p class="tc-name">Researcher Name</p>
          <p class="tc-role">Role / Department</p>
        </div>
        <div class="team-card">
          <p class="tc-uni">University 2</p>
          <p class="tc-name">Researcher Name</p>
          <p class="tc-role">Role / Department</p>
        </div>
        <div class="team-card">
          <p class="tc-uni">University 3</p>
          <p class="tc-name">Researcher Name</p>
          <p class="tc-role">Role / Department</p>
        </div>
      </div>
...
$('logout-btn').addEventListener('click', () => {
  /*
    ...
    Progress flags, workspace content, journal answers, and ratings
    stay in localStorage so the user can log back in and continue
